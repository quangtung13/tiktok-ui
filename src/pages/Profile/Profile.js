        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('video-container')}>
                <div className={cx('tabs')}>
                    <div className={cx('video-tab')} onMouseOver={handleMoveToLeft} onMouseUp={handleClickVideo}>
                        <span>Videos</span>
                    </div>
                    <div className={cx('liked-tab')} onMouseOver={handleMoveToRight} onMouseUp={handleClickLiked}>
                        <span>
                            <LockSolidIcon /> Liked
                        </span>
                    </div>
